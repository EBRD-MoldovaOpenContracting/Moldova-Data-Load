...
- [DB-1](https://public.api.mepps.openprocurement.net/api/0/tenders) and [DB-2](https://public.mtender.gov.md/tenders) OCDS Application Programming Interfaces (API) as well as their procurement data mapping rules (for the examples of the [OCDS](https://standard.open-contracting.org/latest/en/) structure of the [DB-1](https://public.api.mepps.openprocurement.net/api/0/tenders) and [DB-2](https://public.mtender.gov.md/tenders) see ["OCDS data structure of the DB-1 API"](https://github.com/EBRD-MoldovaOpenContracting/Moldova-Data-Load/tree/master/OCDS%20structures/OCDS%20data%20structure%20of%20the%20Meapps%20system) and ["OCDS data structure of the DB-2 API"](https://github.com/EBRD-MoldovaOpenContracting/Moldova-Data-Load/tree/master/OCDS%20structures/OCDS%20data%20structure%20of%20the%20MTender%20system) respectively);
...
- Review the source code from the [GitHub repository](https://github.com/younginnovations/opencontracting-moldova) of the old version of the Moldova OCDS Contract Data Visualisation tool, which was designed by another technical team. Consider whether it can be adjusted to receive new data from the [DB-1](https://public.api.mepps.openprocurement.net/api/0/tenders) and [DB-2](https://public.mtender.gov.md/tenders) databases along with the old ones, thus operating in the multi-platform environment.
...
- Develop a data import module that aims to extract data from the [DB-1](https://public.api.mepps.openprocurement.net/api/0/tenders) and [DB-2](https://public.mtender.gov.md/tenders) OCDS APIs, transform it to the required [OCDS](https://standard.open-contracting.org/latest/en/) format used on the web portal and further export these [OCDS](https://standard.open-contracting.org/latest/en/) formatted data as a JSON or comma-separated values (CSV) file.
...
- Development of the Import-Module to grep  data from the [DB-1](https://public.api.mepps.openprocurement.net/api/0/tenders) and [DB-2](https://public.mtender.gov.md/tenders) APIs;
