...
The differences between the systems and approaches to the publication of data in the OCDS format led to our decision to consolidate the multi-platform system data at the database level. We created a dedicated OCDS database using the MongoDB database and organised the storage of all data in the special collections to consolidate the multi-platform system data. We consider this approach the most suitable in similar situations.
