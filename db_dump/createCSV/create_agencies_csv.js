...
db.ocds_release.find().forEach(function(release){
		...
		if(agencies.indexOf(release.buyer.name) == -1){
				...
				var t = {
			        ...
			        'address'  : (typeof release.buyer.address !== 'undefined')?release.buyer.address.streetAddress:'-',
			        'email'    : (typeof release.buyer.contactPoint !== 'undefined')?release.buyer.contactPoint.email:'-',
			        'phone'    : (typeof release.buyer.contactPoint !== 'undefined')?release.buyer.contactPoint.telephone:'-',
			        'url'      : (typeof release.buyer.contactPoint !== 'undefined')?release.buyer.contactPoint.url:'-'
				}
